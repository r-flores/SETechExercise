...
public class UtilPropDBFloresDiary {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\Ricky\\Workspace4830\\workspace4830-git-Flores\\webprojct-TE-1005-Flores\\WebContent\\config.properties";
